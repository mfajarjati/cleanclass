...
<body>
    ...
    <aside class="sidebar">
        <div class="toggle-btn" onclick="onClickToggle()">
    ...
    <main class="main">
        <div class="theme-toggle" onclick="changeTheme()">
    ...
    <div class="main-content">
        <header>
            ...
            <div class="user-wrapper">
                <img src="assets/images/cat.jpg" width="30px" height="30px" alt="">
                <div>
                    <h4>Firda Rosela Sundari</h4>
                    <small>NIS. 12345678</small>
                </div>
            </div>
        </header>
        <main>
            <div class="cards">
                <div class="card-single">
                    <div>
                        <h1>Wali Kelas</h1>
                        <span>Wildan Tisna Surya M.T.</span>
                    </div>
                    <div>
                        ...
                        <div class="card-body">
                            <div class="customer">
                                <div class="info">
                                    ...
                                    <div>
                                        <h4>Kelas 7B</h4>
                                        <small>Abdurrahman Bin Auf</small>
                                    </div>
                                </div>
                                <div class="contact">
                                    <button>500<span class="">
                                        </span></button>
                                </div>
                            </div>
                            <div class="customer">
                                <div class="info">
                                    ...
                                    <div>
                                        <h4>Kelas 8B</h4>
                                        <small>Salman Al-Farisi</small>
                                    </div>
                                </div>
                                <div>
                                    <button>480<span class="">
                                        </span></button>
                                </div>
                            </div>
                            <div class="customer">
                                <div class="info">
                                    ...
                                    <div>
                                        <h4>Kelas 9B</h4>
                                        <small>Abdullah Bin Umar</small>
                                    </div>
                                </div>
                                <div>
                                    <button>460<span class="">
                                        </span></button>
                                </div>
                            </div>
